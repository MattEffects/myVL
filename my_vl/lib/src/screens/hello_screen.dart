...
class _HelloScreenState extends State<HelloScreen>
  ...
  void initState() {
    ...
    blurAnimation = Tween(begin: 5.0, end: 1.0).animate(CurvedAnimation(
      parent: mainAnimationController,
      curve: Curves.easeIn,
    ));
  }
  ...
  Widget _movingText({@required Listenable animation, @required String title, @required String subtitle}) {
    return AnimatedBuilder(
      animation: animation,
      builder: (context, child) {
        return Align(
